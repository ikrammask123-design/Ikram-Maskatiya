          ...
          <div>
            ...
            <ul className="text-xs sm:text-sm flex flex-col gap-3">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a href="tel:+918320144742" className="hover:text-[#6d0026]">
                  +91 83201 44742
                </a>
              </li>
              <li className="flex items-center gap-2.5">
                ...
                <a
                  href="https://wa.me/918320144742?text=Hello%20Zevioza%20Support%2C%20I%20have%20an%20inquiry"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-emerald-700 text-[#574144] font-medium"
                >
                  WhatsApp: +91 83201 44742
                </a>
              </li>
              <li className="flex items-center gap-2.5">
